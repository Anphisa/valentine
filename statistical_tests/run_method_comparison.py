...
all_strategies = coma_strategies + cupid_strategies + distribution_strategies + similarity_strategies + naive_strategies
...
for comp_dir in tqdm(dir_names):
    ...
    if pkl_exists:
        ...
        for strategy in all_strategies:
            # TODO: Second part may not work (checking for failed matchers)
